...
<body>
    <div class="container-fluid" style="min-width: 320px;">
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbar-collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="active">
                            <a href="/../../PayHost/singleFollowUp/refund.vbhtml">Refund</a>
                        </li>
                        <li>
                            <a href="/../../PayHost/singleFollowUp/simple_refund.vbhtml">Simple refund</a>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div class="container">
            <form role="form" class="form-horizontal text-left" action="refund.vbhtml" method="post">
