        ...
        <nav class="navbar navbar-inverse navbar-fixed-top">
            <div class="container-fluid">
                ...
                <div class="navbar-header">
                    ...
                    <span style="color: #f4f4f4; font-size: 18px; line-height: 45px; margin-right: 10px;"><strong>PayHost Delete Vault</strong></span>
                </div>
                    ...
                    <ul class="nav navbar-nav">
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                <li>
                                    <a href="../cardVault/index.vbhtml">Card Vault</a>
                                </li>
                                <li>
                                    <a href="../cardVault/simple_cardVault.vbhtml">Simple Version</a>
                                </li>
                            </ul>
                        </li>
                        <li class="dropdown active">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                <li>
                                    <a href="index.vbhtml">Delete Vault</a>
                                </li>
                                <li>
                                    <a href="simple_deleteVault.vbhtml">Simple Version</a>
                                </li>
                            </ul>
                        </li>
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                <li>
                                    <a href="../lookupVault/index.vbhtml">Lookup Vault</a>
                                </li>
                                <li>
                                    <a href="../lookupVault/simple_lookupVault.vbhtml">Simple Version</a>
                                </li>
                            </ul>
                        </li>
                    </ul>
            ...
            <form role="form" class="form-horizontal text-left" action="index.vbhtml" method="post">
                ...
                <div class="form-group">
                    <div class=" col-sm-offset-4 col-sm-4">
                        ...
                        <input class="btn btn-success btn-block" id="doVaultBtn" type="submit" name="btnSubmit" value="Do Delete Vault" />
                    </div>
                </div>
                <br>
            </form>
